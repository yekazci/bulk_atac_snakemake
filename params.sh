...
configFile="/fast/AG_Bunina/Yusuf/ATAC_BULK_snakemake/bunina_lab_atac_test/config.yaml"
...
snakefile="/fast/AG_Bunina/Yusuf/ATAC_BULK_snakemake/bunina_lab_atac_test/Snakefile_PE.sh"
...
clusterConfig="/fast/AG_Bunina/Yusuf/ATAC_BULK_snakemake/bunina_lab_atac_test/cluster_resource.yaml"